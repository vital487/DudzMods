 ...
 *
 *    Keep the TestModElements object in this class and all calls to this object
...
public class TestMod {
	...
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation("test", "test"), () -> PROTOCOL_VERSION,
			PROTOCOL_VERSION::equals, PROTOCOL_VERSION::equals);
	public TestModElements elements;
	public TestMod() {
		elements = new TestModElements();
